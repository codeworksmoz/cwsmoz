...
const contributionWays = [
  {
    ...
    description: "Nossa maior necessidade é a criação de conteúdo educacional. Se você tem conhecimento em programação, pode nos ajudar a adicionar novas lições, exercícios e quizzes, garantindo que o Codworks MOZ seja cada vez mais completo.",
  ...
  },
  {
    ...
    description: "Fale outra língua? Ajude-nos a tornar o Codworks MOZ acessível para mais pessoas traduzindo o currículo e a interface para outras línguas moçambicanas e do mundo. Sua ajuda é fundamental para a nossa missão.",
      ...
      <main className="flex-1 container mx-auto px-4 py-12 md:py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground mt-4 max-w-3xl mx-auto">
            O Codworks MOZ é um projeto de código aberto, construído pela comunidade e para a comunidade. Sua contribuição, não importa o tamanho, tem um impacto direto na educação de milhares de pessoas em Moçambique e além.
          </p>
        </div>
